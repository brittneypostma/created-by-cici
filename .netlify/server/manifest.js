  ...
  _: {
    ...
    routes: [
      ...
      },
      {
        ...
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => __toESM(require("./entries/endpoints/product/index.json.js")))
      },
      {
        type: "endpoint",
        ...
        names: ["slug"],
        types: [null],
        load: () => Promise.resolve().then(() => __toESM(require("./entries/endpoints/product/_slug_.json.js")))
      },
      {
        type: "page",
        id: "product/[slug]",
